<!-- 后台 - 顶部窗体 -->
<template>
	<div class="top-window" v-show="store.userInfo.username">
		<div class="top-window-left">
			<!-- 大屏幕显示 logo -->
			<match-media :min-width="768">
				<span class="logo-box"><image src="../static/images/logo-a.jpg" /></span>
			</match-media>
			<!-- 小屏幕显示菜单按钮 -->
		...
		<div class="top-window-right">
			...
			<el-dropdown :hide-timeout="75">
				<div class="username-box">
					...
					<Icon color="#4F88CF"><AngleDown /></Icon>
				</div>
				<template #dropdown>
					<el-dropdown-menu>
		...
		<el-dialog v-model="showResetPwd" title="修改密码" width="300px" top="30vh" destroy-on-close>
...
import { Link, AngleDown, ThList } from '@vicons/fa'
